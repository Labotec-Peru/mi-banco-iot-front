...
export const ESTADOS_NEVERA: EstadoNevera[] = [
  { value: 0, label: "Operativo - Cartera", filterKey: "Operativo - Cartera" },
  { value: 1, label: "Operativo - Censo", filterKey: "Operativo - Censo" },
  { value: 2, label: "Operativo - Instalación", filterKey: "Operativo - Instalación" },
  { value: 3, label: "Taller", filterKey: "Taller" },
  { value: 4, label: "Distribuidor", filterKey: "Distribuidor" },
  { value: 5, label: "Desconexión por Energía", filterKey: "Desconexión por Energía" },
  { value: 6, label: "Fuera de Zona", filterKey: "Fuera de Zona" },
  { value: 7, label: "Fuera de Línea", filterKey: "Fuera de Línea" },
];
